...
base47PKGS="GLib GObject Atk Gio Secret cairo Pango PangoCairo GdkPixbuf Gdk Gtk GtkSource Soup GIRepository Poppler JavaScriptCore-3.0 WebKit Vte Notify OSTree"
