...
base47PKGS="GLib GObject Atk Gio Secret cairo Pango PangoCairo GdkPixbuf Gdk Gtk GtkSource Soup GIRepository Poppler Vte Notify OSTree Ggit xlib GdkX11 Dbusmenu DbusmenuGtk3 Wnck Handy"
