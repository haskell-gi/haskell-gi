...
base47PKGS="GLib GObject Atk Gio Secret Soup cairo Pango PangoCairo GdkPixbuf Gdk Gtk GtkSource GIRepository Poppler JavaScriptCore-3.0 WebKit Vte Notify OSTree Ggit xlib GdkX11 Dbusmenu DbusmenuGtk3"
